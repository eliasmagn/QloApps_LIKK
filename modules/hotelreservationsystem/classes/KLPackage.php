...
class KLPackage extends ObjectModel
{
    /** @var string */
    public $package_code;
    ...
    public static $definition = array(
        'table' => 'kl_package',
        'primary' => 'id_kl_package',
        'multilang' => true,
        'fields' => array(
            'package_code' => array('type' => self::TYPE_STRING, 'validate' => 'isCleanHtml', 'required' => true, 'size' => 64),
            ...
            'duration_mode' => array('type' => self::TYPE_STRING, 'validate' => 'isCleanHtml', 'size' => 16),
            'duration_value' => array('type' => self::TYPE_INT, 'validate' => 'isUnsignedInt'),
    ...
    public function getComponents()
    {
        ...
        return KLPackageComponent::getComponentsForPackage((int) $this->id);
    }
