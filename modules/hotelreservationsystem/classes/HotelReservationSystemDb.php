...
class HotelReservationSystemDb
{
    public function getModuleSql()
    {
        return array(
            ...
            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."kl_rate_plan` (
                `id_kl_rate_plan` int(10) unsigned NOT NULL AUTO_INCREMENT,
                `plan_code` varchar(64) NOT NULL,
                `pricing_method` varchar(32) NOT NULL,
                `currency_iso_code` char(3) NOT NULL,
                `is_active` tinyint(1) unsigned NOT NULL DEFAULT 0,
                `resource_kind_scope` text,
                `audience_segment_scope` text,
                `cancellation_policy_notes` text,
                `advance_required_minor` int(11) DEFAULT NULL,
                `approval_required` tinyint(1) unsigned NOT NULL DEFAULT 0,
                `created_by` int(10) unsigned DEFAULT NULL,
                `updated_by` int(10) unsigned DEFAULT NULL,
                `date_add` datetime NOT NULL,
                `date_upd` datetime NOT NULL,
                PRIMARY KEY (`id_kl_rate_plan`),
                UNIQUE KEY `plan_code_unique` (`plan_code`),
                KEY `is_active` (`is_active`)
            ) ENGINE="._MYSQL_ENGINE_." DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1;",

            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."kl_rate_plan_lang` (
                `id_kl_rate_plan` int(10) unsigned NOT NULL,
                `id_lang` int(10) unsigned NOT NULL,
                `name` varchar(255) NOT NULL,
                `tagline` varchar(255) DEFAULT NULL,
                `description` text,
                PRIMARY KEY (`id_kl_rate_plan`, `id_lang`),
                KEY `id_lang` (`id_lang`)
            ) ENGINE="._MYSQL_ENGINE_." DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;",

            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."kl_rate_plan_season` (
                `id_kl_rate_plan_season` int(10) unsigned NOT NULL AUTO_INCREMENT,
                `id_kl_rate_plan` int(10) unsigned NOT NULL,
                `internal_label` varchar(128) DEFAULT NULL,
                `date_from` date DEFAULT NULL,
                `date_to` date DEFAULT NULL,
                `adjustment_method` varchar(16) NOT NULL,
                `adjustment_amount_minor` int(11) DEFAULT NULL,
                `adjustment_percent_basis_points` int(11) DEFAULT NULL,
                `min_stay_nights` smallint(5) unsigned DEFAULT NULL,
                `max_stay_nights` smallint(5) unsigned DEFAULT NULL,
                `min_occupancy` smallint(5) unsigned DEFAULT NULL,
                `max_occupancy` smallint(5) unsigned DEFAULT NULL,
                `min_lead_days` smallint(5) unsigned DEFAULT NULL,
                `max_lead_days` smallint(5) unsigned DEFAULT NULL,
                `date_add` datetime NOT NULL,
                `date_upd` datetime NOT NULL,
                PRIMARY KEY (`id_kl_rate_plan_season`),
                KEY `id_kl_rate_plan` (`id_kl_rate_plan`)
            ) ENGINE="._MYSQL_ENGINE_." DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1;",

            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."kl_package` (
                `id_kl_package` int(10) unsigned NOT NULL AUTO_INCREMENT,
                `package_code` varchar(64) NOT NULL,
                `id_kl_rate_plan` int(10) unsigned DEFAULT NULL,
                `is_active` tinyint(1) unsigned NOT NULL DEFAULT 0,
                `resource_kind_scope` text,
                `audience_segment_scope` text,
                `duration_mode` varchar(16) DEFAULT NULL,
                ...
                `date_add` datetime NOT NULL,
                `date_upd` datetime NOT NULL,
                PRIMARY KEY (`id_kl_package`),
                UNIQUE KEY `package_code_unique` (`package_code`),
                KEY `id_kl_rate_plan` (`id_kl_rate_plan`)
            ) ENGINE="._MYSQL_ENGINE_." DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1;",

            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."kl_package_lang` (
                `id_kl_package` int(10) unsigned NOT NULL,
                `id_lang` int(10) unsigned NOT NULL,
                `name` varchar(255) NOT NULL,
                `tagline` varchar(255) DEFAULT NULL,
                `description` text,
                PRIMARY KEY (`id_kl_package`, `id_lang`),
                KEY `id_lang` (`id_lang`)
            ) ENGINE="._MYSQL_ENGINE_." DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;",

            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."kl_package_component` (
                `id_kl_package_component` int(10) unsigned NOT NULL AUTO_INCREMENT,
                `id_kl_package` int(10) unsigned NOT NULL,
                ...
                `price_minor` int(11) DEFAULT NULL,
                `id_kl_rate_plan` int(10) unsigned DEFAULT NULL,
                `sort_order` int(10) unsigned NOT NULL DEFAULT 0,
                `date_add` datetime NOT NULL,
                `date_upd` datetime NOT NULL,
                PRIMARY KEY (`id_kl_package_component`),
                KEY `id_kl_package` (`id_kl_package`)
            ) ENGINE="._MYSQL_ENGINE_." DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1;",

            "CREATE TABLE IF NOT EXISTS `"._DB_PREFIX_."kl_quote` (
                `id_kl_quote` int(10) unsigned NOT NULL AUTO_INCREMENT,
                `id_inquiry` int(10) unsigned NOT NULL,
                `id_employee_author` int(10) unsigned DEFAULT NULL,
                `id_kl_rate_plan` int(10) unsigned DEFAULT NULL,
                `id_kl_package` int(10) unsigned DEFAULT NULL,
                `status` varchar(32) NOT NULL DEFAULT 'draft',
                `currency_iso_code` char(3) NOT NULL,
                `net_total_minor` int(11) NOT NULL DEFAULT 0,
                `tax_total_minor` int(11) NOT NULL DEFAULT 0,
                `gross_total_minor` int(11) NOT NULL DEFAULT 0,
                `payload` longtext,
                `notes_internal` text,
                ...
                `date_add` datetime NOT NULL,
                `date_upd` datetime NOT NULL,
                PRIMARY KEY (`id_kl_quote`),
                KEY `id_inquiry` (`id_inquiry`),
                KEY `id_kl_rate_plan` (`id_kl_rate_plan`),
                KEY `id_kl_package` (`id_kl_package`),
                KEY `status` (`status`)
            ) ENGINE="._MYSQL_ENGINE_." DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci AUTO_INCREMENT=1;",
    ...
    public function dropTables()
    {
        return Db::getInstance()->execute(
            ...
            `'._DB_PREFIX_.'kl_rate_plan`,
            `'._DB_PREFIX_.'kl_rate_plan_lang`,
            `'._DB_PREFIX_.'kl_rate_plan_season`,
            `'._DB_PREFIX_.'kl_package`,
            `'._DB_PREFIX_.'kl_package_lang`,
            `'._DB_PREFIX_.'kl_package_component`,
            `'._DB_PREFIX_.'kl_quote`,
