...
require_once 'classes/KLRatePlan.php';
require_once 'classes/KLRatePlanSeason.php';
...
require_once 'classes/KLQuoteMailDispatcher.php';
require_once 'classes/QuotePdfGenerator.php';
