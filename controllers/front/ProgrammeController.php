...
class ProgrammeControllerCore extends FrontController
{
    ...
    public function initContent()
    {
        ...
        $payload = $presenter->presentProgrammeLanding();

        $this->context->smarty->assign(array(
            'storytelling' => $payload,
        ));

        $this->setTemplate(_PS_THEME_DIR_.'storytelling/programme.tpl');
    }
}
