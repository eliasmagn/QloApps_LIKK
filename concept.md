...
- The inquiry lookup controller now exposes cached JSON actions for storytelling testimonials and FAQs keyed by resource type, guarded by HTTPS checks, module activation and lightweight throttling so headless consumers can pull CMS slots without hitting raw tables.
